...
public class TinySpluckProducer {
	...
	public static void main(final String args[]) {
		...
		ctx.start();
		final MessageChannel channelRestoutput = ctx.getBean("splunkOutboundChannelAdapter", MessageChannel.class);
		SplunkOutboundChannelAdapter bean = ctx.getBean("toSplunk", SplunkOutboundChannelAdapter.class);
