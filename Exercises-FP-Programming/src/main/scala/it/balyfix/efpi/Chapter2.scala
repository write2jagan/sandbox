...
object Chapter2 {
   ...
   * is the technique of transforming a function that takes multiple arguments into a function that 
   * takes a single argument (the other arguments having been specified by the curry).
   */
